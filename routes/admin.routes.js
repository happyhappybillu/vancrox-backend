...
// ✅ USER DETAILS + HISTORY (IMPORTANT)
router.get(
...
router.post(
  "/trader/approve-history",
  protect,
  requireRole("admin"),
  admin.approveTradingHistory
);

router.post(
  "/trader/reject-history",
  protect,
  requireRole("admin"),
  admin.rejectTradingHistory
);
